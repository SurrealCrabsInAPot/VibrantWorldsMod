...
public class ModelShadeling<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "shadeling"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hitbox_r1 = hitbox.addOrReplaceChild("hitbox_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(2.0F, -6.0F, 2.0F, -4.0F, 0.0F, -3.0F,
						new CubeDeformation(5.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition Sprout = partdefinition.addOrReplaceChild("Sprout", CubeListBuilder.create(),
				PartPose.offset(-1.0F, 14.0F, 1.0F));

		PartDefinition LeafAccent_r1 = Sprout.addOrReplaceChild("LeafAccent_r1",
				CubeListBuilder.create().texOffs(27, 4)
						.addBox(-4.0F, -13.0F, 1.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 28)
						.addBox(-2.0F, -14.0F, -1.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(10, 28)
						.addBox(-3.0F, -14.0F, 0.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(20, 28)
						.addBox(-2.0F, -13.0F, 1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 10.0F, -1.0F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition Shadow = partdefinition.addOrReplaceChild("Shadow", CubeListBuilder.create(),
				PartPose.offset(0.0F, 17.0F, 0.0F));

		PartDefinition Shadowlayer1_r1 = Shadow.addOrReplaceChild("Shadowlayer1_r1",
				CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F,
		...
		PartDefinition Eye_r1 = bb_main.addOrReplaceChild("Eye_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(1.0F, -9.0F, 3.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 14)
						.addBox(-2.0F, -9.0F, 3.0F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));

		PartDefinition Body_r1 = bb_main.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(22, 8).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 6.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLeg_r1 = bb_main.addOrReplaceChild("LeftLeg_r1",
				CubeListBuilder.create().texOffs(21, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r1 = bb_main.addOrReplaceChild("RightLeg_r1",
				CubeListBuilder.create().texOffs(26, 26).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 4.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, -4.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));
