...
public class ModelCarfungle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "carfungle"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-6.0F, -10.0F, 4.0F, 4.0F, 4.0F, -6.0F, new CubeDeformation(0.0F)).texOffs(36, 56)
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.0F, -10.0F, 4.0F, 4.0F, 4.0F, -6.0F, new CubeDeformation(0.0F)).texOffs(0, 56)
		...
		PartDefinition Mushroom = partdefinition.addOrReplaceChild("Mushroom", CubeListBuilder.create(),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Stem = Mushroom.addOrReplaceChild("Stem",
				CubeListBuilder.create().texOffs(52, 88)
						.addBox(-4.0F, -18.0F, 8.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(60, 88)
		...
		PartDefinition Cap = Mushroom.addOrReplaceChild("Cap",
				CubeListBuilder.create().texOffs(64, 80)
						.addBox(-6.0F, -20.0F, 12.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(78, 64)
		...
		PartDefinition cube_r1 = Cap.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(76, 30)
						.addBox(6.0F, -20.0F, 4.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(76, 26)
		...
		PartDefinition ForeheadBloom = Mushroom.addOrReplaceChild("ForeheadBloom",
				CubeListBuilder.create().texOffs(54, 18)
						.addBox(-11.0F, -20.0F, 12.0F, 12.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(60, 56)
						.addBox(-11.0F, -22.0F, 6.0F, 12.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.0F, 8.0F, 13.0F));

		PartDefinition cube_r2 = ForeheadBloom.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(76, 22)
						.addBox(5.0F, -20.0F, -4.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(60, 64)
		...
		PartDefinition Tail = partdefinition.addOrReplaceChild("Tail",
				CubeListBuilder.create().texOffs(38, 84)
						.addBox(-4.0F, -12.0F, -14.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(30, 84)
		...
		PartDefinition eyesocket_r1 = Tail.addOrReplaceChild("eyesocket_r1",
				CubeListBuilder.create().texOffs(0, 34)
						.addBox(8.0F, -26.0F, 2.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 56)
		...
		PartDefinition Tailbase2 = Tail.addOrReplaceChild("Tailbase2",
				CubeListBuilder.create().texOffs(58, 34)
						.addBox(-6.0F, -8.0F, -18.0F, 12.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(90, 48)
		...
		PartDefinition TailMid = Tail.addOrReplaceChild("TailMid",
				CubeListBuilder.create().texOffs(14, 84)
						.addBox(1.0F, -10.0F, -22.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 84)
		...
		PartDefinition LowerJaw = Tail.addOrReplaceChild("LowerJaw", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Tailspikesmall8_r1 = LowerJaw.addOrReplaceChild("Tailspikesmall8_r1",
				CubeListBuilder.create().texOffs(68, 86)
						.addBox(10.0F, -13.0F, 7.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(42, 74)
						...
						.addBox(-8.0F, -13.0F, 11.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 34)
						.addBox(-9.0F, -12.0F, 6.0F, 22.0F, 8.0F, 14.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Tailspikesmall9_r1 = LowerJaw.addOrReplaceChild("Tailspikesmall9_r1",
				CubeListBuilder.create().texOffs(46, 84)
						.addBox(20.0F, -11.0F, -8.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 56)
						.addBox(20.0F, -13.0F, -6.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(82, 80)
						.addBox(20.0F, -11.0F, -4.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Tailspiketall6_r1 = LowerJaw.addOrReplaceChild("Tailspiketall6_r1",
				CubeListBuilder.create().texOffs(24, 56)
						.addBox(20.0F, -13.0F, 1.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(82, 18)
						.addBox(20.0F, -11.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 64)
						.addBox(20.0F, -11.0F, 3.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 0.0F, 0.0F, -1.5765F, -1.3092F, 1.5651F));

		PartDefinition Tailend = Tail.addOrReplaceChild("Tailend",
				CubeListBuilder.create().texOffs(24, 56)
						.addBox(-4.0F, -2.0F, -8.0F, 4.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(74, 88)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-16.0F, -12.0F, -12.0F, 16.0F, 12.0F, 22.0F, new CubeDeformation(0.0F)).texOffs(48, 74)
		...
		PartDefinition LeftBodySpikes = Body.addOrReplaceChild("LeftBodySpikes", CubeListBuilder.create(),
				PartPose.offset(-10.0F, 0.0F, 0.0F));

		PartDefinition RightBodySpikes = Body.addOrReplaceChild("RightBodySpikes", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));
