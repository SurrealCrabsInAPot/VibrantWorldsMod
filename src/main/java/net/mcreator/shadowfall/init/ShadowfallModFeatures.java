...
public class ShadowfallModFeatures {
	...
	static {
		REGISTRY.put(ShadelandsWaterFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.LAKES, ShadelandsWaterFeature.GENERATE_BIOMES,
				ShadelandsWaterFeature.CONFIGURED_FEATURE));
		REGISTRY.put(SoulEchoFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION, SoulEchoFeature.GENERATE_BIOMES,
				SoulEchoFeature.CONFIGURED_FEATURE));
		REGISTRY.put(PurshroomFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.VEGETAL_DECORATION, PurshroomFeature.GENERATE_BIOMES,
				PurshroomFeature.CONFIGURED_FEATURE));
	}
