...
import net.mcreator.shadowfall.procedures.ShadelingRightClickedOnEntityProcedure;
import net.mcreator.shadowfall.init.ShadowfallModEntities;

import java.util.Set;

@Mod.EventBusSubscriber
public class ShadelingEntity extends PathfinderMob {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("shadowfall:shadelands"),
			new ResourceLocation("dripstone_caves"), new ResourceLocation("lush_caves"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(Items.WHEAT_SEEDS));
	}
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		ShadelingRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
