...
public class CarfungalEntity extends TamableAnimal {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, AmbientCreature.class, true, false));
		...
		this.goalSelector.addGoal(17, new WaterAvoidingRandomStrollGoal(this, 0.8));
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("shadowfall:carfungal_grumble"));
	}
